...
const elemental =    ["지배자",        "신",             "The Elemental"];
...
export const pelleQuotes = {
  ...
  beatAlpha: {
    ...
    lines: [
      ...
      "내 힘이 돌아왔다.",
      "너를 벌하고 싶지만...",
      "네가 Alpha의 정신적 사슬에서 나를 풀어 준 걸 생각하면...",
      "한 번 더 기회를 주지.",
  ...
  reachGoal: {
    ...
    lines: [
      ...
      "아, 그리고 마침내 내가 Alpha에게 붙인 이름이 기억났다.",
      { text: "$1.", 1: weak },
      { text: "$1", 1: confusing },
      "가능한 한 빨리 와라."
    ]
