export const effarigQuotes = {
  ...
  expansionPacks: {
    ...
    lines: [
      ...
      "왜 그렇게 힘을 뿜으며 빛나고 있어?",
      "잠깐...",
      "The Nameless Ones가 어떻게 감옥을 빠져나온 거지?"
    ]
  },
  effarigPack: {
    id: 9,
  ...
  glyphLevel1: {
    ...
    lines: [
      ...
      "참고로 그 연금술 자원은 나도 Ra와 함께 만들었어.",
      "나는 현실 글리프가 가장 자랑스러웠어.",
      "거기에 Teresa의 상징까지 넣었지...",
      "묻지 마. 대답 안 할 거야.",
      "어쨌든, 계속 올라가 봐.",
      "몸조심하고."
    ]
  ...
  glyphLevel2: {
    ...
    lines: [
      ...
      "The Elemental과 나는 그런 건 계획하지 않았는데...",
