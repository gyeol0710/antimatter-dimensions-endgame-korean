export const laitelaQuotes = {
  ...
  expansionPacks: {
    ...
    lines: [
      ...
      "제바아아아알???",
      "잠깐, 파괴자가 왜 여기 있어?",
      "펠레, 네가 파괴자를 쓰러뜨린 줄 알았는데.",
      "그냥 시간을 더 주고 있던 거야?",
      "친절하긴 한데, 저런 자는 그런 자비를 받을 자격이 없어.",
      "좋아, 라부터 처단하고 그다음 파괴자도 처단할게.",
      "그러면 괜찮지, 펠레?"
    ]
  },
  dmd5: {
  ...
  dmd8: {
    ...
    lines: [
      ...
      "펠레를 파괴한 거야???",
      "어떻게?",
      "다른 무엇으로도 펠레를 파괴할 수 없었을 텐데...",
      "엘리멘탈이 어떤 식으로든 널 돕고 있는 게 틀림없어.",
      "그는 어디 있지?",
      "어떻게 모를 수가 있어?",
  ...
  autoHadron: {
    ...
    lines: [
      "안녕, 파괴자.",
      "여기서 날 볼 줄은 몰랐겠지?",
      "내 현실에 하던 일을 펠레의 옛 현실에도 똑같이 하고 있더라.",
